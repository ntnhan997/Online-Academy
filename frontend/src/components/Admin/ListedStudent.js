...
import { ListedStudentAction } from '../../actions/adminAction';
...
export default function ListedStudent() {


    const list = useSelector(state => state.listedStudent);
    const {listedStudents} = list;
    const rows = listedStudents;
