...
import { ListedTeacherAction } from '../../actions/adminAction';
...
export default function ListedTeacher() {


    const list = useSelector(state => state.listedTeacher);
    const {listedTeachers} = list;
    const rows = listedTeachers;
